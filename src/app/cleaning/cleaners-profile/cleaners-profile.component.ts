...
@Component({
  selector: 'app-cleaners-profile',
  templateUrl: './cleaners-profile.component.html',
  styleUrls: ['./cleaners-profile.component.scss']
})
export class CleanersProfileComponent implements OnInit {
