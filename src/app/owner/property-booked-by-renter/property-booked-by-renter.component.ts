...
@Component({
  selector: 'app-property-booked-by-renter',
  templateUrl: './property-booked-by-renter.component.html',
  styleUrls: ['./property-booked-by-renter.component.scss']
})
export class PropertyBookedByRenterComponent implements OnInit {
